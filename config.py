...
# --- محتوای متنی ---
START_MESSAGE = (
    "۱) سلام، من میلاد فیروزی هستم. به ربات مهندس‌یار خوش‌آمدید.\n"
    "این ربات برای کمک به ساخت رزومه حرفه‌ای و شناسایی مهارت‌های شما طراحی شده است. امیدوارم تجربه‌ای مفید داشته باشید.\n\n"
    "۲) ⚠️این سامانه با هدف تسهیل فرآیند تدوین رزومه، ارزیابی اولیه مهارت‌ها و ایجاد بانک اطلاعاتی از نیروهای متخصص حوزه شهرسازی طراحی شده است. لطفاً پیش از ورود اطلاعات، موارد زیر را با دقت مطالعه فرمایید:\n\n"
    ...
    "3. تمام مسئولیت صحت اطلاعات ثبت‌شده بر عهده کاربر است.\n"
    "4. ثبت اطلاعات در این سامانه به معنای قبول شرایط فوق و رضایت از نحوه استفاده از داده‌ها می‌باشد.\n\n"
    "⚜️در صورت موافقت با شرایط، می‌توانید فرآیند رزومه‌سازی را آغاز نمایید."
)
SUCCESS_MESSAGE = (
